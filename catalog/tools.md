...
|------|---------|----------|--------|
| **SheetProof** | Deterministic Excel/CSV analysis — every number is computed by pandas and returned with provenance, never generated by the model. | Spreadsheet Q&A, reporting, group-by and pivot tables, trends, outlier and duplicate detection, data-quality checks | [Almehmadi-Ai/sheetproof](https://github.com/Almehmadi-Ai/sheetproof) |
